    ...
    return (
        <footer
            ...
            <div className="space-y-4 lg:space-x-10">
                ...
                <div className="flex flex-col space-y-2 text-[18px]">
                    <a href="/privacy" className="hover:text-[#53007B]">Privacy</a>
                    <a href="/terms" className="hover:text-[#53007B]">Terms and Conditions</a>
                    <a href="/disclaimer" className="hover:text-[#53007B]">Disclaimer</a>
                </div>
            </div>
            ...
            <div className="space-y-4 lg:space-x-10">
                ...
                <div className="flex flex-col space-y-2 text-[18px]">
                    <Link href="https://www.instagram.com/heartofafrica2025/" className="hover:text-[#53007B]">Facebook</Link>
                    <Link href="https://tiktok.com/@sabiyouculture" className="hover:text-[#53007B]">TikTok</Link>
                    <Link href="https://youtube.com/@heartofafrica2025" className="hover:text-[#53007B]">LinkedIn</Link>
                </div>
            </div>
        </footer>
